...
const bucketListNavClick = (e) => {
  displayList(e.currentTarget.dataset.index);
};
...
export const getBucketListNavigator = (BucketList) => {
  ...
  for (let i = 0; i < BucketList.length; i++) {
    ...
    let bucketTitleAnchor = document.createElement("a");
    bucketTitleAnchor.href = "#";
    bucketTitleAnchor.innerText = BucketList[i].title;
    bucketTitle.innerHTML =
      '<svg class="icon bucket" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11.5 7.63C11.97 7.35 12.58 7.5 12.86 8C13.14 8.47 12.97 9.09 12.5 9.36L4.27 14.11C3.79 14.39 3.18 14.23 2.9 13.75C2.62 13.27 2.79 12.66 3.27 12.38L11.5 7.63M7 21L5.79 14.97L13.21 10.69C14 10.26 14.5 9.44 14.5 8.5C14.5 7.12 13.38 6 12 6C11.53 6 11.09 6.13 10.71 6.36L4.76 9.79L4 6H3V4H21V6H20L17 21H7Z" /></svg>';
    bucketTitle.append(bucketTitleAnchor);

    let todoAnchor = document.createElement("a");
    todoAnchor.href = "#";
    todoAnchor.innerText = "Todos";
    subBucketTodos.append(todoAnchor);
    subBucketTodos.dataset.index = `${i}#todo`;
    subBucketTodos.addEventListener("click", bucketListNavClick);

    let noteAnchor = document.createElement("a");
    noteAnchor.href = "#";
    noteAnchor.innerText = "Notes";
    subBucketNotes.append(noteAnchor);
